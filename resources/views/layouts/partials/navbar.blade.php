<ul class="nav navbar-nav">
  ...
  @if (Auth::check())
    ...
    <li @if (Request::is('admin/merchandisetag*')) class="active" @endif>
      <a href="/admin/merchandisetag"><span class="glyphicon glyphicon-heart"></span> MerchandiseTag</a>
    </li>
    <li @if (Request::is('admin/merchandises*')) class="active" @endif>
      <a href="/admin/merchandises"><span class="glyphicon glyphicon-shopping-cart"></span> Merchandise</a>
    </li>
